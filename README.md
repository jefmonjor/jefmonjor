...
| **[Portfolio](https://github.com/jefmonjor/portfolio)** | [Web en vivo](https://portfolio-omega-drab-fsvg6tmcd2.vercel.app) **construida con IA y que usa IA**: asistente conversacional con dossier cerrado, CV inteligente (completo/ATS/adaptado a oferta con IA), terminal interactiva (prueba el comando `web`) e identidad de diseño propia | Next.js · TypeScript · OpenAI · tRPC · next-intl |
